...
Update from 22 September 2021: We realized we need to decide how to model germination: is it a germination curve each season (can we do this in the ODE solver? Might be more realistic and similar to data, but not how we want the model to be) or is it an amount you go one day (in which case we can use that info in the initial conditions of the ODE solver)?\\
