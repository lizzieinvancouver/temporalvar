...
\begin{align*}
\noindent For the case where 
\tau_{p} \sim & \beta(p,q)\\
\noindent we can calculate the expected value and variance of \tau_{p,t} explicitly: 
