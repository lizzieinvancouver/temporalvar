...
\date{Last updated: 16 May 2017 \\ North Shore of Oahu/Cambridge}
\maketitle
...
\subsection{Git on Odyssey}
Lizzie will work on this.

\subsection{Model parameters}
Work on file with possible parameter values (Lizzie). 
