...
\begin{figure}[h!]
 ...
 \includegraphics[width=\textwidth]{..//plots/prief_conception.png}
    \caption{\textbf{Co-occur species can differ substantially in their phenological sensitivity ($\Delta$ phenological event/$\Delta$ climate) to the environment.} Panel a) estimates the phenological sensitivity of germination timing to chilling and forcing for eleven herbaceous species of eastern North America. Points represent the mean estimate and thick and thin bars represent the 50 and 90\% uncertainty intervals with the full posterior distribution displayed. In b) and c) we highlight the phenological sensitivity to chilling of two species \emph{Eurybia divaricata} and \emph{Persicaria virginiana} that are commonly observed in competition. b) depicts the full sensitivity of each species to chilling of each species, predicted from Bayesian accelerated failure time models, with thick lines representing the mean estimate and lighter lines depict 1000 draws from the posterior distribution to represent uncertainty. Panel c) illustrations how the species' different sensitivities depicted in b) manifest in contrasting realized germination differences under different climate conditions. Point represent the predicted mean number of days to 50\% germination and bars the 90\% uncertainty intervals. Under six weeks of chilling \emph{E. divaricata} germinates well before \emph{P. virginiana}. Under nine weeks of chilling the species germination at roughly the same time, and under twelve weeks of chilling \emph{P. virginiana} is the first to germinate.}
...
\begin{figure}[h!]
 ...
 \includegraphics[width=\textwidth]{..//plots/coexistance_explainer.jpeg}
  % \caption{The relationship between phenological sensitivty and realized phenology under two climate scenarios,  a) demonstrate the relationship between phenological sensitivity differences and realized phenological differences under 12 and 6 weeks of chilling. b) depicts the average differences in phenology between species in simulations with 12 and 6 weeks of chilling. }
...
\begin{figure}[h!]
 ...
 \includegraphics[width=\textwidth]{..//plots/coexistance_runner_new.jpeg}
    %\caption{Trade off between phenological differences and competitive differences a) and phenological sensitivty differences and competitive differences b) under two climate scenarios. The tradeoff between phenology and competition doesn't shift, how ever the trade off between sensitivity and competition does, because larger differences in sensitivity are require to achieve the same phenological differences.}
