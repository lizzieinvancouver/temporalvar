...
\end{enumerate}
which resulted in 176 papers. From here we used the following criteria to determine from which papers we could not extract data: no phenological change measured (46 papers), no trait(s) measured (42 papers) or analyzed (1 paper), single-species studies focused on intra-specific variation (32 papers), no phenology measured (10 papers), modeling studies without data (8 papers), or papers without new data presented (reviews, etc.: 6 papers), or miscellaneous reasons (1 paper measured a phenological response to grazing, while another ... XX). This left us with only 27 papers including relevant data. 
