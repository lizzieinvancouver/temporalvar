...
Three major reasons for not observing tracking ...
\begin{enumerate}
\item Statistical artifacts ... 
\begin{enumerate}
\item days/decade or such ... Sensitivity varies over time due to variation in climate (some decades more variable than others)
\item Releatedly, climate varies more in some parts of the season ... for example, for temperate systems temperature varies strongly early and late in season ... this means greater variation in x axis for species with phenology then. 
\item Daily thermal sums have increased with warming which can decrease estimates of change in days per C
\item Longer series and weaker effects (Gelman, Bolmgren) … CaraDonna/Pearse, Kharouba 2018, Brown 2016 % Bolmgren, K; Vanhoenacker, D; Miller-Rushing, AJ (2013) One man, 73 years, and 25 species. Evaluating phenological responses using a lifelong study of first flowering dates
\end{enumerate}
\item Lack of firm biological understanding to statistically model (dormancy example)
\item It’s not there (bet-hedging for longer-generation species?)
\end{enumerate}
