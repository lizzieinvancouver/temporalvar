...
\begin{enumerate}
\item {\bf Are these effectively the same trait (so no trade-off possible)?}
\item {\bf In a stationary environment both are equally useful ways to match to the environment}
