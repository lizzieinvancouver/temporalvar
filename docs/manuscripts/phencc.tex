...
% START HERE (or above if we need more transition?) 
Coexistence models based on variable environments allow us to test whether species that can track environmental change will perform best with change also (as species respond to shifting resources, which are influenced both by abiotic stressors and the use of the resource by other species.
