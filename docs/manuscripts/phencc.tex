...
\begin{figure}[t!]
\centering
\includegraphics[width=1\textwidth]{..//..//R/graphs/conceptual/conceptdraft.png}
\caption{NEEDS work ... I think we should have different panels for the germination curves in the two sample years. What do you think?}
 \label{fig:concept}
\end{figure}
