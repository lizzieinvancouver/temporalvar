...
\\
Variation in how well species track highlights that---despite the clear importance of tracking for resource access---not all species appear to track their environments equally well. 
START HERE! .... Check outline as we can here hit some numbers on variation in tracking, then switch to why: (1) it's hard to measure (keep this quick? Reference box?) and (2) maybe it's not always optimal to track ... boom, coexistence theory to the rescue!
