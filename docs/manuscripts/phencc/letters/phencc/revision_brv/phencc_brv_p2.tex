...
We had a missing comma here, which we have corrected. We meant that new species could persist, or communities could be continually re-assembled if non-stationarity continued. \\
