...
% Other models have considered timing between two species as modifiers of parameters critical to coexistence: for example, CITERUDOLF,, thus linking phenology to basic competition models. Stage-specific models ... anything to say here?
