...
% START HERE! 
% Then need to review/reimagine and decide if this is working (feels off)
...
\begin{enumerate}
\item Intro
\item What is tracking? (Including how much do species track?)
\begin{enumerate}
...
\item How much do species track? How variable is it across (and within) species? Some examples ...
\begin{enumerate}
