...
So ... new structure might have:
\begin{enumerate}
\item What is tracking?
\item How variable is tracking? What predicts the variation?
\item How is the environment changing (not sure where this goes or how critical)?
...
\item How variable is tracking? What predicts the variation?
\begin{enumerate}
\item How much do species track? How variable is it across (and within) species? How does it work across cues and environments?
\begin{enumerate}
...
\item threshold cues 
\item days/degree
\item plots of plants, insects, birds and then the same insects/birds as trackers of their lower level
\item multicue species may appear as single cue initially with warming
\item complexity in multicue species
\item biotic tracking (competition, predaction etc.)
\item snowmelt date versus temp and similar correlations
\end{enumerate}
\end{enumerate}
\item How is the environment changing (not sure where this goes or how critical)?
\begin{enumerate}
\item Transitions between stationary and non-stationary ... and what changes (mean, variance) 
\item Contrast R0, epsilon and tauP?
\item Some examples
\begin{enumerate}
...
\item What traits co-vary with tracking (trade-offs and the opposite of trade-offs ... syngergies?)
\begin{enumerate}
\item Meta-analysis of traits that co-vary with tracking (small, quick one)
\begin{enumerate}
