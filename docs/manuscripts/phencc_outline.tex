...
% START HERE! 
% Quick review of outline here then...  
% Delete or mv to bottom of document all the other stuff
% Review one more time (think on how to weave in the modeling terms throughout the paper) and ...
% Write!
...
\item And that predictability may vary with generation time ... (Interannual variation in climate versus generation time)
...
\item {\bf Discussion}
\begin{enumerate}
\item Tracking is important, especially now with climate change
\item Current models of coexistence are primed to help understand how a nonstationary environment, such as the one produced by climate change, will alter communities. 
