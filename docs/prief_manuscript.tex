...
\author{Daniel M. Buonaiuto $^{1,2,3,a}$, Megan Donahue$^{4}$,  Elizabeth M. Wolkovich$^{2,3,5}$}
...
Any changes in the environment thus filter through species-specific sensitivities, affecting both inter- and intra-annual germination dynamics, and transform differences in realized phenology between species (Figure \ref{Fig:differences}b). 
