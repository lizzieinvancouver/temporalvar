...
To improve forecasting community assembly for a changing environment we must extend community assembly model to leverage this inter-dependence between environmental variability, phenological variability and variability competition strength.%DMB I am trying to tie back to the ideas two paragraphs ago where we say all other models fix one of these aspects.
...
%Predicting phenological responses to a changing environment requires approaches that allow species phenology to vary with the environment based on the underlying physiology. 


%For most species, this means understanding how the environment is shifting and how those shifts filter through species-specific cue systems (Chmura et al 2019 and Bonamour et al. 2019). In addition to warming spring temperatures, phenological phases such as leafout and seed germination that produce seasonal priority effects in plants are influenced by the duration of exposure to that cool winter temperatures (chilling) and integrating this component into models is likely critical for useful assembly forecasts because of its effects on realized phenology. 
