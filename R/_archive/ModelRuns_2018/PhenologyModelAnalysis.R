...
######################
### This code ran through 15 April 2018
# It uses the folders listed below, which were a mid-set of model runs
# If you want to re-run it check RC or OrangeFiend or the blue Seagate HD that Megan has!
######################
