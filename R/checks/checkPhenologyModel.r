...
## Note! This code is not stand-alone, it cannot run without other code #
...
## Excellent question. This file is something I (Lizzie) built in December 2013 while in Hawaii with Megan #
# The goal was to check some basic assumptions of phenologyModel.R #
# So, if you ever wanted to run this, you would ideally need to pull (from git) #
# a version of phenologymodel.R from December 2013 and then run these snippets #
# which all basically change this or that and check for some expected change in this or that #
# note that we have adjusted phenologyModel.R a LOT since Dec 2013 (added odesolve, changed lists etc.) #
# so in no way shape or form could you run this with that #

# But, you could use it for reasoning of what to do to play with the model in a check this/check that fashion ##
