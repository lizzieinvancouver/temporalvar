...
if (is.character(inputs$tracking)) {
  ...
  tracking <- as.numeric(inputs$tracking)
}
...
if (localflag==0){
  ...
  locOUT <- paste0("/home/victor/projects/temporalvar/R/scratch/")
  locSAVE <- ifelse(megaDflag==1,
                    "/home/victor/projects/temporalvar/R/output/megadrought",
                    "/home/victor/projects/temporalvar/R/output")
  # "C:/Users/Megan/Documents/GitHub/temporalvar/megadrought/output"
